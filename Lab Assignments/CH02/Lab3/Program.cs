...
double salary1_2026 = salary1_2025 *  PERCENT_RAISE;
double salary2_2026 = salary2_2025 * PERCENT_RAISE;
double salary3_2026 = salary3_2025 * PERCENT_RAISE;

double salary1_2027 = salary1_2026 * PERCENT_RAISE;
double salary2_2027 = salary2_2026 * PERCENT_RAISE;
double salary3_2027 = salary3_2026 * PERCENT_RAISE;
...
Console.WriteLine("2025        {0}            {1}           {2}", salary1_2026, salary2_2026, salary3_2026);
Console.WriteLine("2025        {0}            {1}           {2}", salary1_2027, salary2_2027, salary3_2027);